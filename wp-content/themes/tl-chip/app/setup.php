...
add_action('wp_enqueue_scripts', function () {
    ...
    // wp_deregister_style('query-monitor');
    ...
    wp_enqueue_script('swiper', get_template_directory_uri() . '/front/static/prod/assets/js/separate-js/swiper-bundle.min.js', ['jquery'], null, true);
...
add_action('after_setup_theme', function () {
    ...
    // Enable full width gutenberd block
